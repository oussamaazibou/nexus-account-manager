      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
        ...
        >
          <div className="space-y-6 mt-10">
            ...
            <ModernInput label="Apex A-record IP (optional)" placeholder="e.g. 203.0.113.10 — auto-detected if empty" value={localSettings.dynuApexIp || ''} onChange={(v) => updateField('dynuApexIp', v)} />
            <div className="flex justify-between items-center pt-2">
