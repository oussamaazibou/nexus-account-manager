...
export type ViewType = 'DASHBOARD' | 'QUEUE' | 'OPERATIONS' | 'SETTINGS' | 'VALID_ACCOUNTS' | 'PHONE_VERIFY' | 'MANAGE_ACCOUNTS' | 'UPLOAD_JSON' | 'APP_PASSWORDS' | 'APP_USERS' | 'ONLINE_USERS' | 'ARCHIVE_ACCOUNTS' | 'CREATE_USERS' | 'DOMAINS';
